 ...
 */
module.exports = {
  'timeTitle': 'Our new livestreamer pricing system will be launched soon',
  ...
  'dialogAbout': {
    ...
    'desc1': 'Livestreamer rankings are calculated based on a range of performance indicators. Call prices are determined based on your ranking level and apply to all calls made to you via the platform.',
    'desc2': 'You can increase your ranking by completing basic tasks and receiving activity/earnings rewards.',
    'rangTitle': 'Ranking and corresponding pricing rules',
    'column1': 'Ranking range',
    'column2': 'Video price'
  },
  'dialogPrice': {
    'title': 'Historical price stats',
