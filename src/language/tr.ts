 ...
 * @LastEditTime: 2020-03-04 19:18:11
 * @LastEditors: your name
 * @Description:
 * @FilePath: /assessment/src/language/tr.ts
...
module.exports = {
  ...
  'profileInfo': 'Profili Tamamlama ',
  'interactiveness': 'Etkileşim Durumu',
  'rateLevel': {
    '1': 'Kötü',
    '2': 'Normal',
    '3': 'İyi'
  },
  'win1': 'Tüm yayıncılar içinde',
  ...
  'chartTips': {
    ...
    '3': 'Gelir durumunuz çok düşük. Güncel durumunuzu iyileştirmek ve video sohbeti ücretinizi arttırmak için lütfen aramalara daha çok cevap verip daha çok arkadaş ekleyin.',
    '4': 'Etkileşim durumunuz düşük. Güncel durumunuzu iyileştirmek ve video sohbeti ücretinizi arttırmak için gelen aramaları açmamazlık yapmayın, karşılıklı beğeniler gönderin ve bol bol arkadaş ekleyin.',
  ...
  'dialogAbout': {
    ...
    'desc1': 'Yayıncıların seviyeleri, yayıncının belli bir süre içindeki değerlerinin çeşitli boyutlarda incelenmesine ve yayıncı performansına dayanır. Seviye belirlendikten sonra yayıncı, tüm aramalardan seviyesine karşılık gelen ücreti alır. (Örn: Seviyenize karşılık gelen arama ücreti 120 Altın Para ise tüm gelen aramalardan (Arkadaş Araması-Kraliçe Duvarı Araması-Flash Chat-LiveCam) dakika başına bu ücreti alırsınız.',
    'desc2': 'Güncel seviyenizi arttırıp aramalardan dakika başına daha çok kazanmak için temel görevleri tamamlayıp aktiflik sürenizi arttırıp kurallara daha çok dikkat etmeniz gerekir.',
    'rangTitle': 'Sıralama listesi ve karşılık gelen video sohbeti ücretleri:',
    'column1': 'Sıralama',
    'column2': 'Video Sohbeti Ücreti'
  },
  'dialogPrice': {
    'title': 'Geçmiş ücret değişiklikleri',
    '1': 'Son zamanlarda performansın çok iyi! Bu tempoyu düşürmeden devam et! ',
    '2': 'Kural ihlallerinin azaltılması video sohbeti dakikalık ücretini çok hızlı bir şekilde arttırabilir!',
    '3': 'Video sohbeti dakikalık ücretini arttırmak için arama kaçırmayın ve aktiflik sürenizi arttırın!',
    '4': 'Video sohbetlerden kazancınız {price} Altın Para/dakika şeklinde değişti.'
  }
}
